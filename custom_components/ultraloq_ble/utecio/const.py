from . import MODEL_ALIASES, canonical_model, known_devices
...
DOOR_STATUS = {0: "Open", 1: "Closed", 255: "Unavailable"}
NO_BOLT_STATUS_MODELS = {
    model
    for model in (*known_devices, *MODEL_ALIASES)
    if canonical_model(model) == "U-Bolt-Pro"
}
